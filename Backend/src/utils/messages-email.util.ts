...
export function alertMonitor(username: string, status: string, serviceName: string, time: Date, slug: string, issue: boolean) {
    const FRONTEND_URL = process.env.FRONTEND_URL || ""
    const monitorUrl: string = FRONTEND_URL + "monitors/" + slug
    const message = issue ? "Your monitored service has encountered an issue:" : "The website service has been restored:"
